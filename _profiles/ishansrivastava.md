...
abstract: We are developing numerical algorithms and computational models to simulate
  ...
  discrete element method (DEM), a coarse-grained representation such as particle-in-cell
  ...
  The overarching goal will be a multiscale modeling framework that can simulate a
  wide variety of particulate materials and complex fluids, and is performant on manycore/GPU-based
...
Add additional details about Ishan_Srivastava here using markdown.
