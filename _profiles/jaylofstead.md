...
abstract: Large scale science simulations and observations both generate enormous
  ...
  or derived quantities. For example, an air pressure gradient can show both a hurricane
  as well as straight-line winds. Being able to query for places where the gradient
  meets criteria is more general and helpful when looking for severe weather events.
  This work will help support managing these derived quantities as well as supporting
...
Add additional details about Jay_Lofstead here using markdown.
