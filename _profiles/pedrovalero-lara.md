...
abstract: 'This project is aimed at the implementation, evaluation and optimization
  ...
  software solutions on the available software and hardware platforms. Learning objectives
  for the applicant include: i) develop HPC codes based on performance portable programming
  models, such as OpenMP/OpenACC, C++, Kokkos, Julia, task-based runtimes, on current
...
Add additional details about Pedro_Valero-Lara here using markdown.
