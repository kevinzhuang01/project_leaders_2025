...
abstract: Communication offloading to GPUs represents a hot topic in science and industry.
  ...
  for GPU execution. In this work we examine the current PGAS support for distributed
  parallel programming in Kokkos and evaluate that implementation in comparison to
  proposals coming from the MPI Forum as well as hardware manufactures such as NVIDIA.
...
Add additional details about Jan_Ciesko here using markdown.
