...
abstract: Our work would fall under the HPC/Application Metrology umbrella ("metrology"
  ...
  I am interested in finding someone to help me speed up our High Performance Computing
  (HPC) supercomputers. We know that there are bottlenecks in our simulations, like
  memory, CPU, network, or filesystem limitations. Often these bottlenecks are temporary,
  so they are hard to find or reproduce. We need someone to run applications on the
  supercomputers and then analyze the performance data to find performance anomalies
...
Add additional details about M. Scot_Swan here using markdown.
