...
abstract: Effective programming models offer programmers the ability to harness the
  ...
  running on distributed memory systems. As high-performance GPU computing becomes
  the trend, GPU-initiated communication becomes a viable solution for multi-GPU scaling.
  However, the lack of deep understanding of GPU-initiated communication performance
  and its impact on an application's performance becomes a hurdle. As such, the proposed
  topic is to explore the performance of GPU-initiated communications and CPU-initiated
...
Add additional details about Nan_Ding here using markdown.
