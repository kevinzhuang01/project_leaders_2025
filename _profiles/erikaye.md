...
topics: Computational Science Applications (i.e., bioscience, cosmology, chemistry,
  ...
  Science
status: Accept
abstract: Partial differential equations are used across many scientific fields to
  describe physical phenomena. However, nonlinear PDEs can be difficult to understand
  ...
  equation with surprising success. This project can take many directions, such as
  extending these methods to different PDEs or considering problems with complex geometries.
desired: Coding experience Linear algebra Basic quantum mechanics Numerical simulation
  background
email: erikaye@lbl.gov
---

## Additional Information

Add additional details about Erika_Ye here using markdown.
