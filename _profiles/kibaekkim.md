...
abstract: Federated learning (FL) is a method where multiple devices train machine
  ...
  aims to address the technical challenges by developing and deploying FL models to
  the edge devices available through Argonne National Laboratory. Closely working
...
Add additional details about Kibaek_Kim here using markdown.
