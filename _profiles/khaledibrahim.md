...
abstract: In the performance and algorithms group, we tackle various applications
  ...
  problems. Our SRP visitors are expected to engage in ongoing research efforts within
  our group to engage in an experience in developing performance modeling and tuning
  methods. We also encourage application developers with performance challenges to
  engage with us to apply our developed methods in improving the performance of their
...
Add additional details about Khaled_Ibrahim here using markdown.
