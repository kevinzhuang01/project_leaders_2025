...
abstract: We are interested in understanding the sensitivities of an ocean model's
  ...
  of the model to its parameters. Yet adjoints are very time consuming to develop
  manually and very involved to develop via automatic differentiation (AD) for some
  models. Because neural networks implemented in machine learning frameworks can be
...
Add additional details about Sri Hari Krishna_Narayanan here using markdown.
